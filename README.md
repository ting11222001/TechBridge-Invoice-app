...
[About the TechBridge project](https://tech-bridge-landing-page.vercel.app/) · [Invoice Module Live Demo (backend server on Railway is currently stopped)](https://tech-bridge-invoice-app.vercel.app/) · [Invoice Module (Backend repo)](https://github.com/ting11222001/TechBridge-Invoice) · Donation Module (coming soon)
